...
<div class="flex gap-8">
    <div class="bg-white rounded-lg shadow p-8 flex-1 text-center">
        <div class="text-5xl font-bold text-green-600 mb-2">{nbEmployes}</div>
        <div class="text-lg text-gray-700">Employés</div>
    </div>
    <div class="bg-white rounded-lg shadow p-8 flex-1 text-center">
        <div class="text-5xl font-bold text-blue-600 mb-2">{nbCandidats}</div>
